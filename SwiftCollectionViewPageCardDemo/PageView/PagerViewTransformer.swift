...
open class PagerViewTransformer: NSObject {
    
    open internal(set) weak var pagerView: PagerView?
    open internal(set) var type: PagerViewTransformerType
    
    open var minimumScale: CGFloat = 0.68
    ...
    open func applyTransform(to attributes: PagerViewLayoutAttributes) {
