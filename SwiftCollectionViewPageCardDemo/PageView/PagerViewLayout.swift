...
class PagerViewLayout: UICollectionViewLayout {
    
    var transformer: PagerViewTransformer?
    
    internal var contentSize: CGSize = .zero
    internal var leadingSpacing: CGFloat = 0
    internal var trailingSpacing: CGFloat = 0
    internal var itemSpacing: CGFloat = 0
    internal var needsReprepare = true
    internal var scrollDirection: PagerView.ScrollDirection = .horizontal
    
    fileprivate var pagerView: PagerView? {
        return self.collectionView?.superview?.superview as? PagerView
    }
    ...
    override open func prepare() {
        ...
        self.contentSize = {
            ...
            case .horizontal:
                var contentSizeWidth: CGFloat = self.leadingSpacing + self.trailingSpacing // Leading & trailing spacing
                ...
                return contentSize
            case .vertical:
                var contentSizeHeight: CGFloat = self.leadingSpacing + self.trailingSpacing // Leading & trailing spacing
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        let maxPosition = self.scrollDirection == .horizontal ? min(rect.maxX,self.contentSize.width-self.actualItemSize.width-self.trailingSpacing) : min(rect.maxY,self.contentSize.height-self.actualItemSize.height-self.trailingSpacing)
        ...
        while origin-maxPosition <= max(CGFloat(100.0) * .ulpOfOne * abs(origin+maxPosition), .leastNonzeroMagnitude) {
            ...
            let attributes = self.layoutAttributesForItem(at: indexPath) as! PagerViewLayoutAttributes
    ...
    override open func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        let attributes = PagerViewLayoutAttributes(forCellWith: indexPath)
    ...
    override open func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        func calculateTargetOffset(by proposedOffset: CGFloat, boundedOffset: CGFloat) -> CGFloat {
            ...
            if pagerView.decelerationDistance == PagerView.automaticDistance {
    ...
    internal func contentOffset(for indexPath: IndexPath) -> CGPoint {
        ...
        let contentOffsetX: CGFloat = {
            ...
            let contentOffsetX = origin.x - self.leadingSpacing
        ...
        let contentOffsetY: CGFloat = {
            ...
            let contentOffsetY = origin.y - self.leadingSpacing
    ...
    fileprivate func applyTransform(to attributes: PagerViewLayoutAttributes, with transformer: PagerViewTransformer?) {
